				...
				_createClass(ProjectPreview, [
					{
						...
						value: function init() {
							...
							var projectPreview = (this.projectPreview =
							...
							var projectsImagesBox = (this.projectsImagesBox =
								document.querySelector(".preview-images-item"));
							this.projectsImages = [];
							this.fullPostSliderImages = [];
					...
					},
					{
						...
						value: function onTouch() {
							...
							// touch start
							this.projectPreview.addEventListener(
								"touchstart",
								function (event) {
									...
									if (_this4.hasScroll) {
										...
										showNext =
											_this4.projectPreview.scrollTop ===
											_this4.maxScrollHeight;
									}
					...
					},
					{
						...
						value: function checkScroll() {
							var visibleHeight = (this.offsetHeight =
								this.projectPreview.offsetHeight),
								fullHeight = (this.fullHeight =
									this.projectPreview.scrollHeight);
					...
					},
					{
						...
						value: function animateBoxBot() {
							...
							var animateBoxBot = (this.animateBoxBot =
								document.createElement("DIV"));
							var animateBoxTop = (this.animateBoxTop =
								document.createElement("DIV"));
							var animateWrap = (this.animateWrap =
								document.createElement("DIV"));
					...
					},
					{
						...
						value: function createFullPost() {
							...
							// блок для слайдера
							var slider = (this.fullPostSlider =
								document.createElement("DIV"));
							slider.className = "full-post-slider col-xs-10";
							// блок для елементів
							var images = (this.postSliderImages =
								document.createElement("DIV"));
							...
							var content = (this.fullPostContent =
								document.createElement("DIV"));
							content.className = "full-post-content col-xs-2";
							var contentTableWrapper = (this.contentTableWrapper =
								document.createElement("DIV"));
							...
							var contentFooter = (this.contentFooter =
								document.createElement("DIV"));
							...
							var mobileMenuCloseBtn = (this.mobileMenuCloseBtn =
							...
							var fullPostAnimateBox = (this.fullPostAnimateBox =
								document.createElement("DIV"));
							var animateBoxRight = (this.animateBoxRight =
								document.createElement("DIV"));
							var animateBoxLeft = (this.animateBoxLeft =
								document.createElement("DIV"));
      ...
      /* WEBPACK VAR INJECTION */ (function (process, global, module) {
				...
				(function () {
					...
					if (lib$es6$promise$asap$$isNode) {
						...
						lib$es6$promise$asap$$scheduleFlush =
							lib$es6$promise$asap$$attemptVertx();
					} else {
						lib$es6$promise$asap$$scheduleFlush =
					...
					function lib$es6$promise$$internal$$makePromise(promise) {
						promise[lib$es6$promise$$internal$$PROMISE_ID] =
				  ...
				  */
					function lib$es6$promise$promise$$Promise(resolver) {
						this[lib$es6$promise$$internal$$PROMISE_ID] =
					...
					*/
					...
					lib$es6$promise$enumerator$$Enumerator.prototype._enumerate =
						function () {
							...
							for (
								var i = 0;
								this._state === lib$es6$promise$$internal$$PENDING &&
								i < length;
								i++
							) {
			...
			var Preloader = (function () {
				function Preloader() {
					...
					var preloader = (this.preloader =
						preloaderWrap.querySelector(".atail-preloader"));
				...
				_createClass(AllProjects, [
					{
						...
						value: function init() {
							...
							var allProjectsArray = (this.allProjectsArray =
								allProjects.querySelectorAll(".all-atail-projects-single"));
							...
							this.projectsCategoryWrapper =
								this.currentCategoryArray[0].parentNode;
							...
							var animateBox = (this.animateBox =
								document.createElement("DIV"));
						...
						value: function showProjects(target) {
							...
							(0, _promiseAjax.httpGet)(
								...
								.then(function (data) {
									...
									// for ajax
									var closeProjectsBtn = (_this3.closeProjectsBtn =
										document.createElement("DIV"));
				...
				_createClass(Slider, [
					...
					},
					{
						...
						value: function createAnimateBox() {
							...
							var sliderAnimateBox = (this.sliderAnimateBox =
								document.createElement("DIV"));
							var animateBoxRight = (this.animateBoxRight =
								document.createElement("DIV"));
							var animateBoxLeft = (this.animateBoxLeft =
